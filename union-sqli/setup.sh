...
INSERT INTO faq VALUES (2, 'clarifying','200','What is CTF101?', 'Didn\'t you know what you signed up for...? But anyway, you can find out more about that on our website too.');
INSERT INTO faq VALUES (3, 'open','200','How do I solve this challenge?', 'Think harder about what was taught just now. Clarify any doubts you have fast!');
INSERT INTO faq VALUES (4, 'clarifying','200','Where can I find the answer?', 'Google is your best friend.');
INSERT INTO faq VALUES (5, 'probing','200','Who can tell me the answer?', 'Hints will be given but attempt to solve the challenge yourself first!');
